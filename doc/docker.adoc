...
[source,bash]
----
git clone https://github.com/monkzzz/byos_hanami terminus
cd terminus
bin/setup docker
----
...
Or in the case of using Compose v2
[source,bash]
----
